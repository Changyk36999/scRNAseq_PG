...
cellchat = readRDS("cellchat/PG_CTRL_cellChat.rds")
...
ht1 <- netAnalysis_signalingRole_heatmap(cellchat, pattern = "outgoing", height = 15, signaling = pathways.show.all[1:49])
ht2 <- netAnalysis_signalingRole_heatmap(cellchat, pattern = "incoming", height = 15, signaling = pathways.show.all[1:49])
ht3 <- netAnalysis_signalingRole_heatmap(cellchat, pattern = "outgoing", height = 15, signaling = pathways.show.all[50:98])
ht4 <- netAnalysis_signalingRole_heatmap(cellchat, pattern = "incoming", height = 15, signaling = pathways.show.all[50:98])
...
file.copy(from = list.files(pattern = ".pdf", path = "./", full.names = T), to = "cellchat/plots/")
